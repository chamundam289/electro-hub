    ...
    <section className="py-16 bg-secondary">
      <div className="container-fluid">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-secondary-foreground">
              Hot Deals & Offers
            </h2>
            ...
            >
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-secondary-foreground/10 text-secondary-foreground text-sm">
                ...
                {offer.description && (
                  <p className="text-secondary-foreground/70 mb-6 line-clamp-2">
                    {offer.description}
                  </p>
                )}
