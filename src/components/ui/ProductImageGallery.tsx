...
export function ProductImageGallery({
    ...
    return (
      <Card className={cn('overflow-hidden', className)}>
        <CardContent className="p-0">
          <div className={cn('bg-gray-200 animate-pulse flex items-center justify-center', maxHeight)}>
  ...
  if (images.length === 0) {
    return (
      <Card className={cn('overflow-hidden', className)}>
        <CardContent className="p-0">
          <div className={cn('bg-gray-100 flex items-center justify-center', maxHeight)}>
