        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-200">
            <div className="text-center mb-4">
              ...
              <p className="text-blue-700 text-sm">Total Repair Cost</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-blue-600 mb-1">
                  ...
                  <span className="font-semibold">{quotation.estimated_delivery_days} Days</span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 text-blue-600 mb-1">
                  ...
                  <span className="font-semibold">{quotation.warranty_period_days} Days</span>
                </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {quotation.warranty_description && (
                    <p className="text-sm text-gray-500 mt-1">{quotation.warranty_description}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">Quotation Date</p>
          ...
          {quotation.admin_notes && (
            <div>
              <h4 className="font-semibold text-gray-900 mb-3">Technician Notes</h4>
              <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-amber-600 mt-0.5" />
                  <p className="text-sm text-amber-800">{quotation.admin_notes}</p>
                </div>
              </div>
            </div>
          )}
