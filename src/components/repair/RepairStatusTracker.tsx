    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-3">
          {onContactSupport && (
            <Button variant="outline" size="sm" onClick={onContactSupport} className="flex-1">
          ...
          {currentStatus === 'delivered' && onLeaveFeedback && (
            <Button size="sm" onClick={onLeaveFeedback} className="flex-1 bg-green-600 hover:bg-green-700">
