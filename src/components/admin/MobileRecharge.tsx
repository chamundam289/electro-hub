  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Mobile Recharge Management</h1>
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            <div className="text-center py-8">Loading recharges...</div>
          ) : (
            <>
                  ...
                  <tbody>
                    {paginatedRecharges.map((recharge) => (
                      <tr key={recharge.id} className="border-b hover:bg-gray-50">
                        <td className="p-2 font-medium">{recharge.mobile_number}</td>
                        <td className="p-2">{recharge.operator}</td>
                        <td className="p-2">
                          <Badge variant="outline" className="capitalize">
                            {recharge.plan_type}
                          </Badge>
                        </td>
                        <td className="p-2 font-medium">₹{recharge.recharge_amount}</td>
                        <td className="p-2">
                          <div>
