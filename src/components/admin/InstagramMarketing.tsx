    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{activeStories.length}</div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="story-media">Story Media</TabsTrigger>
        ...
        <TabsContent value="influencers" className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-semibold">Instagram Influencers</h2>
        ...
        <TabsContent value="story-media" className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-semibold">Story Media Management</h2>
            <Button onClick={() => setShowAddStoryMedia(true)}>
