-- ============================================
-- 🚀 LOYALTY SYSTEM QUICK FIX - NO VIEW CONFLICTS
-- ============================================

-- Step 1: Ensure system settings exist and are properly configured
...
-- Step 2: Fix wallet creation conflicts with UPSERT approach
...
-- Step 3: Fix product loyalty settings auto-creation
...
-- Step 4: Ensure ALL existing products have loyalty settings
INSERT INTO public.loyalty_product_settings (
    product_id,
    coins_earned_per_purchase,
    coins_required_to_buy,
...
-- Step 5: Create trigger for auto-creating loyalty settings on new products
...
-- Step 6: Clean up duplicate wallets
...
-- Step 8: Verify and report status
DO $$
DECLARE
...
BEGIN
    ...
    RAISE NOTICE '🎉 LOYALTY SYSTEM QUICK FIX - RESULTS:';
    RAISE NOTICE '✅ System enabled: %', COALESCE(system_enabled, false);
    RAISE NOTICE '✅ Total products: %', total_products;
    RAISE NOTICE '✅ Products with loyalty settings: %', products_with_settings;
    RAISE NOTICE '✅ Total user wallets: %', total_wallets;
    
    IF products_with_settings = total_products AND COALESCE(system_enabled, false) THEN
